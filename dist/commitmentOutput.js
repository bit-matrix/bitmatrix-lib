...
var createCommitmentOutput = function (flagAssetId, pubkey) {
    var flagAssetIdLe = (0, wiz_data_1.hexLE)(flagAssetId);
    //const caseStaticValue = isAddLiquidity ? "51" : "00";
    //No longer used
    var commitmentOutput = "00c86920" + flagAssetIdLe + "876351675ab276a914" + lib_core_1.crypto.hash160v2(wiz_data_1.default.fromHex(pubkey)) + "88ac68";
    return commitmentOutput;
};
exports.createCommitmentOutput = createCommitmentOutput;
var commitmentOutputTapscript = function (flagAssetId, pubkey) {
    var commitmentOutput = (0, exports.createCommitmentOutput)(flagAssetId, pubkey);
