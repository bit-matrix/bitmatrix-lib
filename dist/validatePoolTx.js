...
exports.validatePoolTx2 = exports.validatePoolTx = void 0;
...
var validatePoolTx2 = function (value, slippageTolerance, poolData, methodCall) {
    // 1-Havuzun güncel pair_1 liquidity miktarına pool_pair_1_liquidity ismini ver.
    var pool_pair_1_liquidity = Number(poolData.quote.value);
    // 2-Havuzun güncel pair_2 liquidity miktarına pool_pair_2_liquidity ismini ver.
    var pool_pair_2_liquidity = Number(poolData.token.value);
    ...
    if (methodCall === models_1.CALL_METHOD.SWAP_QUOTE_FOR_TOKEN) {
        ...
        var user_received_pair_2 = Math.floor(user_received_pair_2_apx - payout_additional_fees);
        // ------hesaplar ------
        var user_received_pair_2_apx_w = payout_additional_fees + value;
        console.log("1,", user_received_pair_2_apx_w);
        var new_pair_2_pool_liquidity_apx_2_w = pool_pair_2_liquidity - user_received_pair_2_apx_w;
        console.log("2", new_pair_2_pool_liquidity_apx_2_w);
        var new_pair_2_pool_liquidity_apx_1_w = (0, helper_1.div)(new_pair_2_pool_liquidity_apx_2_w, pair_2_coefficient);
        console.log("3", new_pair_2_pool_liquidity_apx_1_w);
        var constant_coefficient_downgraded_w = (0, helper_1.div)(pool_constant, new_pair_2_pool_liquidity_apx_1_w);
        console.log("4", constant_coefficient_downgraded_w);
        var constant_coefficient_w = (0, helper_1.div)(pair_1_coefficient, constant_coefficient_downgraded_w);
        console.log("5,", constant_coefficient_w);
        var user_supply_available_w = constant_coefficient_w - pool_pair_1_liquidity;
        var user_supply_lp_fees_w = (0, helper_1.div)(user_supply_available_w, 499) * 500;
...
exports.validatePoolTx2 = validatePoolTx2;
