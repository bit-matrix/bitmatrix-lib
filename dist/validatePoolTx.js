...
var validatePoolTx = function (commitmentData, poolData) {
    var cof = commitmentData;
    var method = cof.methodCall;
    var errorMessages = [];
    var output = {
        assetId: "",
        value: 0,
    ...
    //commitment output 2
    var commitmentOutput2 = cof.cmtOutput2;
    // commitment Output2 Asset Id
    var commitmentOutput2AssetId = commitmentOutput2.asset;
    ...
    if (method === "01") {
        ...
        if (lib_core_1.arithmetics64.greaterThan64(wiz_data_1.default.fromHex(cof.slippageTolerance), bn_user_received_pair_2).number === 1) {
        ...
        if (lib_core_1.arithmetics64.greaterThan64(wiz_data_1.default.fromHex(cof.slippageTolerance), bn_user_received_pair_1).number === 1) {
            errorMessages.push("Out of slippage");
            output.assetId = pair_2_asset_id;
            output.value = result.user_supply_total;
            result.new_pool_pair_1_liquidity = pool_pair_1_liquidity;
        ...
        //commitment output 3
        var commitmentOutput3 = cof.cmtOutput3;
        // commitment Output2 Asset Id
        var commitmentOutput3AssetId = commitmentOutput3.asset;
        ...
        if (lib_core_1.arithmetics64.greaterThan64(wiz_data_1.default.fromHex(cof.slippageTolerance), bn_user_lp_received).number === 1) {
            errorMessages.push("Out of slippage");
