...
var validatePoolTx = function (value, slippageTolerance, poolData, methodCall, additionalValue) {
    var slippageToleranceHex = lib_core_1.convertion.numToLE64(wiz_data_1.default.fromNumber(slippageTolerance));
    var errorMessages = [];
    var output = {
        assetId: "",
        value: 0,
    ...
    var pair_1_asset_id = poolData.quote.assetHash;
    var pair_2_asset_id = poolData.token.assetHash;
    var lp_asset_id = poolData.lp.assetHash;
    ...
    if (methodCall === models_1.CALL_METHOD.SWAP_QUOTE_FOR_TOKEN) {
        ...
        result.user_supply_total = new decimal_js_1.default(value).mul(100000000).toNumber();
        ...
        var bn_user_received_pair_2 = lib_core_1.convertion.numToLE64(wiz_data_1.default.fromNumber(result.user_received_pair_2));
        if (lib_core_1.arithmetics64.greaterThan64(slippageToleranceHex, bn_user_received_pair_2).number === 1) {
        ...
        var bn_user_received_pair_1 = lib_core_1.convertion.numToLE64(wiz_data_1.default.fromNumber(result.user_received_pair_1));
        if (lib_core_1.arithmetics64.greaterThan64(slippageToleranceHex, bn_user_received_pair_1).number === 1) {
            errorMessages.push("Out of slippage");
            output.assetId = pair_2_asset_id;
            output.value = result.user_supply_total;
            result.new_pool_pair_1_liquidity = pool_pair_1_liquidity;
    ...
    else if (methodCall === models_1.CALL_METHOD.ADD_LIQUIDITY && additionalValue) {
        ...
        result.user_pair_1_supply_total = new decimal_js_1.default(value).mul(100000000).toNumber();
        // 8- Commitment output 3 miktarına user_pair_2_supply_total ismini ver.
        result.user_pair_2_supply_total = new decimal_js_1.default(additionalValue).mul(100000000).toNumber();
        ...
        var bn_user_lp_received = lib_core_1.convertion.numToLE64(wiz_data_1.default.fromNumber(result.user_lp_received));
        if (lib_core_1.arithmetics64.greaterThan64(slippageToleranceHex, bn_user_lp_received).number === 1) {
            errorMessages.push("Out of slippage");
    ...
    else if (methodCall === models_1.CALL_METHOD.REMOVE_LIQUIDITY) {
        ...
        result.user_lp_supply_total = new decimal_js_1.default(value).mul(100000000).toNumber();
