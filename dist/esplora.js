...
var txDetailPromise = function (txId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        txDetail = new Promise(function (resolve, reject) {
            esplora_api_client_1.esploraClient
                .tx(txId)
                .then(function (tx) {
                resolve(tx);
            })
        ...
        txOutSpends = new Promise(function (resolve, reject) {
            esplora_api_client_1.esploraClient
                .txOutspends(txId)
                .then(function (txOutSpend) {
                resolve(txOutSpend);
            })
                .catch(function (err) {
                console.log(err);
        ...
        return [2 /*return*/, Promise.all([txDetail, txOutSpends])];
    });
}); };
exports.txDetailPromise = txDetailPromise;
