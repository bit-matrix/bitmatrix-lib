...
exports.createCovenantsV2 = exports.bodyCalculaterNV2 = exports.createCovenants = exports.bodyCalculaterN = void 0;
...
var bodyCalculaterNV2 = function (n, flagAssetId, pair1Coefficient) {
...
exports.bodyCalculaterNV2 = bodyCalculaterNV2;
var createCovenantsV2 = function (leafCount, lookupLeafIndex, flagAssetId, pair1Coefficient) {
    var mainCovenantScript = [];
    for (var i = 0; i <= leafCount; i++) {
        mainCovenantScript.push((0, exports.bodyCalculaterNV2)(i, flagAssetId, pair1Coefficient));
    }
    var pubKey = wiz_data_1.default.fromHex("1dae61a4a8f841952be3a511502d4f56e889ffa0685aa0098773ea2d4309f624");
    var scriptsWizData = mainCovenantScript.map(function (mcs) { return wiz_data_1.default.fromHex(mcs); });
    var controlBlock = lib_core_1.taproot.controlBlockCalculation(scriptsWizData, "c4", pubKey.hex, lookupLeafIndex);
...
exports.createCovenantsV2 = createCovenantsV2;
